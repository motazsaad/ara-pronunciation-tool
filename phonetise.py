...
ambiguousConsonantMap = {
    u'\u0644': [u'l', u''], u'\u0648': u'w', u'\u064a': u'y', u'\u0629': [u't', u'']
...
nunationMap = {
    u'\u064b': [[u'a', u'n'], [u'A', u'n']], u'\u064c': [[u'u1', u'n'], [u'U1', u'n']],
    u'\u064d': [[u'i1', u'n'], [u'I1', u'n']]
}
...
consonants = [u'\u0623', u'\u0625', u'\u0626', u'\u0624', u'\u0621', u'\u0628', u'\u062a', u'\u062b', u'\u062c',
              u'\u062d', u'\u062e', u'\u062f', u'\u0630', u'\u0631', u'\u0632', u'\u0633', u'\u0634', u'\u0635',
              u'\u0636', u'\u0637', u'\u0638', u'\u0639', u'\u063a', u'\u0641', u'\u0642', u'\u0643', u'\u0644',
              u'\u0645', u'\u0646', u'\u0647', u'\u0622']
...
def isFixedWord(word, results, orthography):
    ...
    wordConsonants = re.sub(
        u'[^\u0647\u0630\u0627\u0647\u0646\u0621\u0623\u0648\u0644\u0626\u0643\u0645\u064A\u0637\u062a\u0641\u062F]',
        '', word)  # Remove all dacritics from word
    if (wordConsonants in fixedWords):  # check if word is in the fixed word lookup table
        if (isinstance(fixedWords[wordConsonants], list)):
            ...
            results += orthography + ' ' + fixedWords[
...
for utterance in utterances:
    ...
    utteranceLabelFile = open("labels/ARA NORM  " + zeros + number + ".lab", mode="w", encoding="utf-8")
    ...
    for word in utterance:
        ...
        if word != '-':
            ...
            for index in range(2, len(word) - 2):
                ...
                # ----------------------------------------------------------------------------------------------------------------
                if (letter in consonants + [u'\u0648', u'\u064a'] and not letter in emphatics + [
                    u'\u0631'""", u'\u0644'"""]):  # non-emphatic consonants (except for Lam and Ra) change emphasis to 'no emphasis'
                    emphaticContext = False
                ...
                if (letter == u'\u0644'):
                    if ((not letter1 in diacritics and not letter1 in vowelMap) and letter2 in [
                        u'\u0651']):  # Lam could be omitted in definite article (sun letters)
                        phones += [ambiguousConsonantMap[u'\u0644'][1]]
                    else:
                        phones += [ambiguousConsonantMap[u'\u0644'][0]]
                # ----------------------------------------------------------------------------------------------------------------
                if (letter == u'\u0651' and not letter_1 in [u'\u0648',
                                                             u'\u064a']):  # shadda just doubles the letter before it
                ...
                if (letter in vowelMap):
                    if (letter in [u'\u0648',
                                   u'\u064a']):  # Waw and Ya are complex they could be consonants or vowels and their gemination is complex as it could be a combination of a vowel and consonants
                        if (letter1 in diacriticsWithoutShadda + [u'\u0627', u'\u0649'] or (
                                letter1 in [u'\u0648', u'\u064a'] and not letter2 in diacritics + [u'\u0627', u'\u0648',
                                                                                                   u'\u064a']) or (
                                letter_1 in diacriticsWithoutShadda and letter1 in consonants + [u'e'])):
                            if ((letter in [u'\u0648'] and letter_1 in [u'\u064f'] and not letter1 in [u'\u064e',
                                                                                                       u'\u0650',
                                                                                                       u'\u0627',
                                                                                                       u'\u0649']) or (
                                        letter in [u'\u064a'] and letter_1 in [u'\u0650'] and not letter1 in [u'\u064e',
                                                                                                              u'\u064f',
                                                                                                              u'\u0627',
                                                                                                              u'\u0649'])):
                                if (emphaticContext):
                            ...
                            if (letter_1 in [u'\u064e'] or (
                                    letter in [u'\u0648'] and letter_1 in [u'\u0650', u'\u064a']) or (
                                    letter in [u'\u064a'] and letter_1 in [u'\u0648', u'\u064f'])):
                            ...
                            if (emphaticContext):
                                ...
                                if (letter_1 in consonants + [u'\u064f', u'\u0650'] and letter1 in [u'e']):
                                    ...
                                    phones += [vowelMap[letter][0][0]]
                    if (letter in [u'\u064f',
                                   u'\u0650']):  # Kasra and Damma could be mildened if before a final silent consonant
                        if (emphaticContext):
                            if ((
                                        letter1 in unambiguousConsonantMap or letter1 == u'\u0644') and letter2 == u'e' and len(
                                    word) > 7):
                            ...
                            if ((
                                ...
                                phones += [vowelMap[letter][0][0]]
                    if (letter in [u'\u064e', u'\u0627',
                                   u'\u0649']):  # Alif could be ommited in definite article and beginning of some words
                        ...
                        elif (letter in [u'\u0627'] and letter_1 in [u'\u0648'] and letter1 in [
            ...
            for pronunciation in pronunciations:
                ...
                for i in range(0, len(pronunciation)):
                    ...
                    if (letter in ['aa', 'uu0', 'ii0', 'AA', 'UU0', 'II0'] and prevLetter.lower() == letter[
                                                                                                     1:].lower()):
                        toDelete.append(i - 1)
